...
public class OutputStrings {
	...
	public static final String WELCOME_EINRICHTUNG = "Willkommen beim GuideLines Einrichtungsassistenten!<break time=\"0.1s\" /> "
			+ "Die Einrichtung dauert circa f�nf Minuten. <break time=\"0.05s\" /> Moechtest du die Einrichtung jetzt starten? Dann sage bitte \"Einrichtung starten\".";
	public static final String WELCOME_EINRICHTUNG_REPROMPT = "Du befindest dich im Hauptmenü des GuideLines Einrichtungsassistenten. "
			+ "<break time=\"0.05s\" /> M�chtest du die Einrichtung jetzt starten? Dann sage bitte \"Einrichtung starten\".";
	public static final String WELCOME_EINRICHTUNG_CARD = "Willkommen beim GuideLines Einrichtungsassistenten. "
			+ "Die Einrichtung dauert circa f�nf Minuten. M�chtest du die Einrichtung jetzt starten?";
	public static final String EINRICHTUNG_SAY_HOME_ADDRESS_CARD = "Alles klar! Wir beginnen mit der Einrichtung deiner Privatadresse. "
			+ "Wenn du weitere Informationen zu den verschiedenen Schritten ben�tigst sage bitte: "
	...
	public static final String EINRICHTUNG_SAY_HOME_ADDRESS = "Alles klar! <break time=\"0.05s\" /> Wir beginnen mit der Einrichtung deiner Privatadresse. "
			+ "<break time=\"0.05s\" /> Wenn du weitere Informationen zu den verschiedenen Schritten ben�tigst sage bitte: "
	...
	public static final String NO_STREET_PROMPT = "Ich brauche von dir die komplette Adresse. Ich brauche mindestens die Stadt und die Stra�e. Bitte sag mir nochmal deine Adresse.";
