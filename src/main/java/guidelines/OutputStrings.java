...
public enum OutputStrings {
	...
	EINRICHTUNG_NAME_A_SPEECH("Gut! Ich habe die Adresse gespeichert. Wie möchtest du dein erstes Ziel benennen?"),
	EINRICHTUNG_NAME_A_CARD("Gut! Ich habe die Adresse gespeichert. Wie möchtest du dein erstes Ziel benennen?"),
...
EINRICHTUNG_DEST_B_CARD("Wie lautet die Adresse deines zweiten Ziels?"),
	...
	EINRICHTUNG_NAME_B_SPEECH("Gut! Ich habe die Adresse gespeichert. <break time=\"0.05s\" />Wie möchtest du dein zweites Ziel benennen?"),
	EINRICHTUNG_NAME_B_CARD("Gut! Ich habe die Adresse gespeichert. Wie möchtest du dein zweites Ziel benennen?"),
